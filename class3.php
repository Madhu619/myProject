...
echo "<center><h2 style='color:black'> Available Class1 Medicine </h2>";
$selectsql="select * from medicine where class='class3'";
...
$selectsql="select * from XX_SAMPLE ";
mysql_query($selectsql);
while($row = mysql_fetch_array($result))
{
echo " <tr> <td>".$row['ID']."</td><td>".$row['IMAGE'];
}
echo "</table> </center>";
?>
