var actualwidth=800; //initial width of the image
var adjustwidth=600; //after enlarge image adjust the other images width
var endwidth=1320; //end width of the image
var tt; //timer
var delay=100; //speed 
