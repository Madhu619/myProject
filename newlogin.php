...
<div id="formbox">
<h2 style="color:black"> Enter Details to Register </h2>


<div id="tab2">
<form action="store.php" method="POST" align="left">
...
<input type="text" name="username" placeholder="Enter Username" pattern="(^[aA-zZ]*)" 
	maxlength="20" required autofocus title="Only Alphabets are allowed." 
...
<input type="text" name="phoneno" placeholder="Enter 10 digit Mobile no" pattern="[^9][0-9]{9}" 
	maxlength="10" title="Enter Valid Mobile Number" 
